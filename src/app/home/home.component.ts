...
@Component({
  ...
  template: `
    <div class="bg-gray-100 min-h-screen flex flex-col">
      <div
        class="flex-grow bg-gradient-to-br from-amber-500 to-yellow-400 text-white py-20"
      >
      ...
      <section class="py-16 bg-zinc-50">
        <div class="max-w-7xl mx-auto px-4">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div
              class="bg-gradient-to-br from-amber-500 to-yellow-400 shadow-md rounded-lg p-6 text-center"
            >
      ...
      <!-- CTA Section -->
      <section class="bg-gradient-to-br from-amber-500 to-yellow-400 py-16">
        <div class="max-w-7xl mx-auto px-4 text-center">
